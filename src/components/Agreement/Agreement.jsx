...
const handleClear = () => {
  ...
  //               const response = await axios.post('http://52.20.55.193:5001/api/sign/save', formData, {
  //                   headers: {
  ...
  //   // try {
  //   //   await axios.post('http://52.20.55.193:5001/api/sign/save', { 
  //   //     userId,
...
const handleSubmit = async (e) => {
  ...
  if (uploadedFile && userId) {
    try {
      ...
      const uploadResponse = await axios.post('http://52.20.55.193:5001/api/sign/save', formData, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
      ...
      const pdfResponse = await axios.post('http://52.20.55.193:5001/generate-pdf', { userId });
      ...
      const updatePdfResponse = await axios.put('http://52.20.55.193:5001/api/sign/update-pdf', {
        userId,
