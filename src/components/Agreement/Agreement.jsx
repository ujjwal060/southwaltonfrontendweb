...
const handleClear = () => {
  ...
  //   // try {
  //   //   await axios.post('http://98.82.228.18:5001/api/sign/save', { 
  //   //     userId,
...
const handleSubmit = async (e) => {
  ...
  if (uploadedFile && userId) {
    try {
      ...
      const uploadResponse = await axios.post('http://98.82.228.18:5001/api/sign/save', formData, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
      ...
      const pdfResponse = await axios.post('http://98.82.228.18:5001/generate-pdf', { userId });
      ...
      const updatePdfResponse = await axios.put('http://98.82.228.18:5001/api/sign/update-pdf', {
        userId,
