...
const ReservePage2 = ({ hideContent }) => {
                                        ...
                                        <>
                                            ...
                                            <div className="d-flex flex-column gap-3">
                                                ...
                                                <div className="row">
                                                    ...
                                                    {/* Reservation Deposit (Already Paid) */}
                                                    <div className="col-md-6">
                                                    ...
                                                    <div className="col-md-6">
                                                        <div className="p-3 bg-light rounded h-100">
                                                            ...
                                                            <div className="d-flex flex-column">
                                                                ...
                                                                <div className="d-flex justify-content-end mb-2">
                                                                    <span className="fw-bold text-danger">Reservation Deposit Paid:</span>
                                                                    <span className="text-end fw-bold text-danger" style={{ minWidth: "80px" }}>
                                                                        - $100.00
                                                                    </span>
                                                                </div>
                                                                <div className="d-flex justify-content-end border-top pt-2">
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        style={{ minWidth: "80px" }}
                                                                    >
                                                                        ${((parseFloat(vehicleDetails.totalPrice.replace("$", "")) * 1.12) - 100).toFixed(2)}
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div className="p-3 bg-dark text-white rounded mt-4">
                                                    <div className="d-flex flex-column">
                                                        <div className="d-flex justify-content-end">
                                                            <h6 className="mb-0 fw-bold me-auto">Total Due Now (USD)</h6>
                                                            <h5 className="fw-bold mb-0 text-end" style={{ minWidth: "80px" }}>
                                                                ${((parseFloat(vehicleDetails.totalPrice.replace("$", "")) * 1.12) - 100).toFixed(2)}
                                                            </h5>
                                                        </div>
                                                        <small className="text-white text-end">
                                                            Reservation deposit already paid. This amount is for vehicle rental only.
                                                        </small>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="d-flex flex-wrap gap-3 mt-4 p-3 border rounded align-items-center justify-content-between bg-light">
                                                <div className="form-check align-items-center justify-content-center">
                                                    ...
                                                    >
                                                        ...
                                                        I agree to proceed to pay the remaining vehicle amount.
                                                    </label>
                                                </div>
